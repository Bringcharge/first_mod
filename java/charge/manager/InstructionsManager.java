...
public class InstructionsManager {
    public static Entity entityWithString(String instruction, Entity owner) { //返还Entity的方法
        return EntityInstruction.parser(instruction, owner);
    }

    public static Vec3d vecWithString(String instruction, Entity owner) { //返还Vec3d的方法
        return VecInstruction.parser(instruction, owner);
    }

    public static int integerWithString(String instruction, Entity owner) { //返还integer的方法
        return IntegerInstruction.parser(instruction, owner);
    }

    public static double doubleWithString(String instruction, Entity owner) { //返还double的方法
